	...
	dynamicPage(name: "mainPage", uninstall: true, install: true) {
		section() {
            if(state.endpoint) {
                ...
                def accessStr = """${state.fullEndpoint}?access_token=${state.secret}&dashboardAppId=${dashboardAppId}&dashboardAccessToken=${dashboardToken}${openWeatherToken ? "&openWeatherToken=${openWeatherMapKey}" : ""}"""
